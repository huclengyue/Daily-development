...
public class DvViewUtil {
    ...
    public static void getViewLocation(View view, int[] location) {
    ...
    public static int getScreenHight() {
        return DvAppUtil.getDisplayMetrics().heightPixels;//宽度height = dm.heightPixels ;//高度
    }
    ...
    public static float px2dp(float pxValue) {
        return pxValue / Resources.getSystem().getDisplayMetrics().density + 0.5f;
    ...
    public static float sp2px(float spValue) {
        return applyDimension(TypedValue.COMPLEX_UNIT_SP, spValue, Resources.getSystem().getDisplayMetrics());
    }
