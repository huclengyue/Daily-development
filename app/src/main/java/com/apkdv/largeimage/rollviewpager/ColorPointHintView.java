...
import static com.apkdv.largeimage.rollviewpager.DvViewUtil.dp2px;
...
public class ColorPointHintView extends ShapeHintView {
    ...
    public Drawable makeFocusDrawable() {
        ...
        dot_focus.setCornerRadius(dp2px(4));
        dot_focus.setSize((int)dp2px(8), (int) dp2px(8));
        return dot_focus;
    }
    ...
    public Drawable makeNormalDrawable() {
        ...
        dot_normal.setCornerRadius(dp2px(4));
        dot_normal.setSize((int)dp2px(8), (int) dp2px(8));
        return dot_normal;
    }
}