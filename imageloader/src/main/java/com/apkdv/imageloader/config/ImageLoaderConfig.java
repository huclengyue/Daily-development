package com.apkdv.imageloader.config;
...
public class ImageLoaderConfig {
     ...
     */
    public ImagePipelineConfig getImagePipelineConfig(OkHttpClient client) {
        if (mImagePipelineConfig == null) {
            mImagePipelineConfig = createConfigBuilder(client)
...
//                    })
     ...
     * @return
     */
    protected ImagePipelineConfig.Builder createConfigBuilder(OkHttpClient client) {
        if (client == null)
            return ImagePipelineConfig.newBuilder(mContext);
        else return OkHttpImagePipelineConfigFactory.newBuilder(mContext, client);
    }
    ...
    protected MemoryTrimmableRegistry getMemoryTrimmableRegistry() {
        ...
        memoryTrimmableRegistry.registerMemoryTrimmable(new MemoryTrimmable() {
            ...
            public void trim(MemoryTrimType trimType) {
                ...
                DvLog.Companion.i("Fresco onCreate suggestedTrimRatio = " + suggestedTrimRatio);
